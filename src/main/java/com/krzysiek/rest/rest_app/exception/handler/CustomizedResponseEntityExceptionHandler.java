...
public class CustomizedResponseEntityExceptionHandler extends ResponseEntityExceptionHandler {
    ...
    @ExceptionHandler(ElementAlreadyExistsOnListException.class)
    public final ResponseEntity<ExceptionResponse> handleElementAlreadyExistsOnListException(Exception ex, WebRequest request) {
        return createExceptionEntity(ex, request, HttpStatus.CONFLICT);
    }
